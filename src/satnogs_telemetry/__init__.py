...
This project provides a small headless telemetry pipeline for SatNOGS data.
...
The package-level module is intentionally lightweight; it only exists to mark
``satnogs_telemetry`` as a Python package.
"""
